...
* [OAuth2 Resource Server](https://docs.spring.io/spring-boot/docs/3.1.1-SNAPSHOT/reference/htmlsingle/#web.security.oauth2.server)
...
### About Project
you should start keyclock and create a account to set rules.
in : http://localhost:8080/admin/master/console/ 
